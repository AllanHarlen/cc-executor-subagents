...
} from "../skills/executor-subagents/scripts/lib/handoff-validator.mjs";

const REPO_ROOT = fileURLToPath(new URL("../", import.meta.url));
const CONTRACT_PATH = join(REPO_ROOT, "skills/executor-subagents/references/handoff-contract.md");
const CLI_SCRIPT = resolve(REPO_ROOT, "skills/executor-subagents/scripts/validate-handoff.mjs");
