...
import { validateHandoff } from "../skills/executor-subagents/scripts/lib/handoff-validator.mjs";
import {
  initRun,
...
function closedRun() {
  ...
  initRun({ slug: "demo", artifactDir, projectRoot: root });
  for (const gate of ["verificacao", "reports"]) updateCompletionGate(artifactDir, gate, "DONE", { projectRoot: root });
...
const validHandoff = () => ({
  ...
  stage: "executor",
  slug: "demo",
  producer: { plugin: "cc-executor-subagents", version: "2.10.0" },
  artifactRoot: ".executor/demo/artefatos",
  status: "DONE",
  createdAt: "2026-09-19T10:00:00.000Z",
  updatedAt: "2026-09-19T10:00:00.000Z",
  summary: "Ajustes aplicados e verificados.",
  upstream: null,
  artifacts: [{ role: "implementation-report", path: "implementation-report.md", required: true }],
  nextStage: null,
});
